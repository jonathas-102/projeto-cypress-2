describe('Acessando a página do Flits', () => {
  it('Deve visitar a página do Flits', () => {
    ...
    .clear()
    .type('30/06/2025{enter}')


    cy.get('[data-testid="Input-title"]').type('Teste de comunicado 10 20 30', { force: true });
    cy.get('[data-testid="TextArea-text"]').type('Este é um teste de comunicado sem emojis para verificar a funcionalidade de criação de mensagens institucionais no sistema.', { force: true });
