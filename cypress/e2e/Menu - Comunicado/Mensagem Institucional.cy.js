describe('Acessando a página do Flits', () => {
  it('Deve visitar a página do Flits', () => {
    ...
    cy.get('[data-testid="1301"] > .sc-iAUPGz > .title').click({ force: true });
    cy.wait(4000);
    ...
    cy.get('[data-testid="TextArea-text"]').type('Este é um teste de Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. FuNcionais no sistema.', { force: true });
   ...
   .contains('007340 - JULIO CESAR DA SILVA')
   .click({ force: true });

   cy.get('.sc-bruwDQ > .ant-btn').click({ force: true });
